...
class _NewOrderPageState extends State<NewOrderPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //                       OutlineButton(
      //                         onPressed: () async {
      //                           final PickedFile imgFile = await ImagePicker()
      //                               .getImage(source: ImageSource.gallery);
      //                           String _url = await ProductModel()
      //                               .insertImage(File(imgFile.path));
      //                           setState(() {
      //                             _imageUrl = _url;
      //                           });
      //                         },
      //                         child: Text(_imageUrl == null
      //                             ? 'Adicionar Imagem'
      //                             : 'Imagem Selecionada'),
      ...
      //                           productData.farm_name = UserModel.of(context)
      //                               .userData
      //                               .farmData
      //                               .name;
      //                           productData.farm_id = UserModel.of(context)
      //                               .userData
      //                               .farmData
      //                               .farmId;
